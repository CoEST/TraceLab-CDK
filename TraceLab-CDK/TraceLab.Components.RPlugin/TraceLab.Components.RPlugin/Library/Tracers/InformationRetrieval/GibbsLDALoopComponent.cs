...
{
    [Component(Name = "(loop) Gibbs Latent Dirichlet Analysis",
                Description = "Performs LDA on a set of artifacts. Imports configurations for use in a loop. Uses package 'topicmodels'",
    ...
    [IOSpec(IOSpecType.Input, "Config", typeof(GibbsLDAConfig))]
    ...
    public class GibbsLDALoopComponent : BaseComponent
    {
        public GibbsLDALoopComponent(ComponentLogger log) : base(log) { }
