...
{
    [Component(Name = "Latent Dirichlet Analysis",
                Description = "Performs LDA on a set of artifacts. Uses package 'lda'",
                Author = "SEMERU; Evan Moritz",
                Version = "1.0.0.0",
                ConfigurationType = typeof(LDAConfig))]
    ...
    public class LDAComponent : BaseComponent
    {
        ...
        public override void Compute()
        {
            ...
            TLSimilarityMatrix sims = (TLSimilarityMatrix) engine.Execute(new LDAScript(source, target, _config));
