...
{
    [Component(Name = "Principal Component Analysis (triple)",
        Description = "Performs PCA on three TLSimilarityMatrix.",
    ...
    public class TriplePCAComponent : BaseComponent
    {
        ...
        public override void Compute()
        {
            ...
            double[] results = (double[])engine.Execute(new PCAScript(matrix1, matrix2, matrix3));
