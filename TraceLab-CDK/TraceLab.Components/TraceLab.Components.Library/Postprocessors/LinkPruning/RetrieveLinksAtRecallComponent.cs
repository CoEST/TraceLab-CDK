...
{
    [Component(Name = "Retreive Links At Specific Recall",
        Description = "Retrieves links from a TLSimilarityMatrix at a specific recall.",
    ...
    public class RetrieveLinksAtRecallComponent : BaseComponent
    {
        private RetrieveLinksAtRecallComponentConfig _config;

        public RetrieveLinksAtRecallComponent(ComponentLogger log)
            : base(log)
        {
            _config = new RetrieveLinksAtRecallComponentConfig();
    ...
    public class RetrieveLinksAtRecallComponentConfig
    {
        public double RecallLevel { get; set; }
    }
}
