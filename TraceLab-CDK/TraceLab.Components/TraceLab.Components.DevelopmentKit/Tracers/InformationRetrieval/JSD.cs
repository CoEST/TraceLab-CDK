...
namespace TraceLab.Components.DevelopmentKit.Tracers.InformationRetrieval
{
    ...
    public static class JSD
    {
        ...
        /// <returns></returns>
        public static double DocumentSimilarity(double[] document1, double[] document2)
        {
            double similarity;
        ...
        public static double entropy(double[] docDistrib)
        {
            int i;
            double entropia = 0;
        ...
        public static double[] sumDocument(double[] document1, double[] document2)
        {
        ...
        public static double[] mulDocument(double pScalar, double[] pVector)
        {
