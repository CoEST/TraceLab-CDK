...
namespace TraceLab.Components.DevelopmentKit.Metrics.Traceability
{
    ...
    /// </summary>
    public class AveragePrecisionQueryComputation : MetricComputation
    {
        #region Members

        private const string _name = "Average Precision (query granularity)";
        private const string _description = "Average precision measures average of the precision values for each correct link. This metric is calculated per query.";
        ...
        public AveragePrecisionQueryComputation(TLSimilarityMatrix candidateMatrix, TLSimilarityMatrix answerMatrix)
            : base()
        {
