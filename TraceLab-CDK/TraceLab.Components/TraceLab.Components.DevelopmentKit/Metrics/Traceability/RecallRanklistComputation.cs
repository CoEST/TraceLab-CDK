...
namespace TraceLab.Components.DevelopmentKit.Metrics.Traceability
{
    ...
    /// </summary>
    public class RecallRanklistComputation : MetricComputation
    {
        #region Members

        private const string _name = "Recall (ranklist granularity)";
        private const string _description = "Recall measures the fraction of correctly retrieved documents among the total correct documents. This metric is computed on the overall ranked list.";
        ...
        /// <summary>
        /// Constructor for the recall computation (ranklist granularity)
        /// </summary>
        /// <param name="candidateMatrix">Candidate links</param>
        /// <param name="answerMatrix">Answer matrix</param>
        public RecallRanklistComputation(TLSimilarityMatrix candidateMatrix, TLSimilarityMatrix answerMatrix)
        {
