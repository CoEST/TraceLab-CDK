...
namespace TraceLab.Components.DevelopmentKit.Metrics.FeatureLocation
{
    ...
    /// </summary>
    public class EffectivenessBestMeasureComputation : MetricComputation
    {
        #region Members

        private const string _name = "Effectiveness Best Measure";
        private const string _description = "Computes the position of the highest ranked correct link. This metric is calculated per query.";
        ...
        /// <summary>
        /// Constructor for the effectiveness best measure computation
        /// </summary>
        /// <param name="candidateMatrix">Candidate links</param>
        /// <param name="answerMatrix">Answer matrix</param>
        public EffectivenessBestMeasureComputation(TLSimilarityMatrix candidateMatrix, TLSimilarityMatrix answerMatrix)
            : base()
        {
        ...
        /// <summary>
        /// Computes the effectiveness best measure of the given similarity matrix using the answer matrix provided.
        /// </summary>
