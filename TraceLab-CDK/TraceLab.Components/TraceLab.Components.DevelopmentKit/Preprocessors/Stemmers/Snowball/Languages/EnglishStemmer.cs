...
{
    /// <summary>
    /// English language Snowball implementation
    /// </summary>
    public class EnglishStemmer : StemmerOperations, ISnowballStemmer
    {
        ...
        /// <summary>
        /// Determines if a term can be stemmed
        /// </summary>
        /// <returns>True if a term can be stemmerd, false otherwise</returns>
        public bool CanStem()
        {
            bool returnn = true;
            bool subroot = false;
